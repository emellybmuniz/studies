...
# --- Page Configuration ---
# Sets the page title, icon, and layout to full width.
st.set_page_config(
...
df_filtrado = df[
    ...
    (df['contrato'].isin(contratos_selecionados)) & # new line
...
if not df_filtrado.empty:
    ...
    st.warning("Nenhum dado para exibir. Por favor, selecione pelo menos uma opção em cada filtro.")
